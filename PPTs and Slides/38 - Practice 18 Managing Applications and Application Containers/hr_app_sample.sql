...
-- **********************************************************
ALTER TABLE HR.JOBS ADD (  CONSTRAINT JOB_ID_PK PRIMARY KEY (JOB_ID) USING INDEX HR.JOB_ID_PK ENABLE VALIDATE);
ALTER TABLE HR.REGIONS ADD ( CONSTRAINT REG_ID_PK PRIMARY KEY  (REGION_ID) USING INDEX HR.REG_ID_PK  ENABLE VALIDATE);
ALTER TABLE HR.LOCATIONS ADD ( CONSTRAINT LOC_ID_PK PRIMARY KEY (LOCATION_ID) USING INDEX HR.LOC_ID_PK ENABLE VALIDATE);
ALTER TABLE HR.DEPARTMENTS ADD ( CONSTRAINT DEPT_ID_PK PRIMARY KEY (DEPARTMENT_ID) USING INDEX HR.DEPT_ID_PK ENABLE VALIDATE);
ALTER TABLE HR.EMPLOYEES ADD ( CONSTRAINT EMP_SALARY_MIN CHECK (salary > 0) ENABLE VALIDATE);
ALTER TABLE HR.EMPLOYEES ADD ( CONSTRAINT EMP_EMP_ID_PK PRIMARY KEY (EMPLOYEE_ID) USING INDEX HR.EMP_EMP_ID_PK ENABLE VALIDATE);

ALTER TABLE HR.COUNTRIES ADD ( CONSTRAINT COUNTR_REG_FK  FOREIGN KEY (REGION_ID)  REFERENCES HR.REGIONS (REGION_ID) ENABLE VALIDATE);
ALTER TABLE HR.LOCATIONS ADD ( CONSTRAINT LOC_C_ID_FK  FOREIGN KEY (COUNTRY_ID)  REFERENCES HR.COUNTRIES (COUNTRY_ID) ENABLE VALIDATE);
ALTER TABLE HR.DEPARTMENTS ADD ( CONSTRAINT DEPT_LOC_FK  FOREIGN KEY (LOCATION_ID)  REFERENCES HR.LOCATIONS (LOCATION_ID) ENABLE VALIDATE);
ALTER TABLE HR.DEPARTMENTS ADD ( CONSTRAINT DEPT_MGR_FK  FOREIGN KEY (MANAGER_ID)  REFERENCES HR.EMPLOYEES (EMPLOYEE_ID)  ENABLE VALIDATE);
ALTER TABLE HR.EMPLOYEES ADD (  CONSTRAINT EMP_DEPT_FK  FOREIGN KEY (DEPARTMENT_ID)  REFERENCES HR.DEPARTMENTS (DEPARTMENT_ID) ENABLE VALIDATE);
ALTER TABLE HR.EMPLOYEES ADD ( CONSTRAINT EMP_JOB_FK  FOREIGN KEY (JOB_ID)  REFERENCES HR.JOBS (JOB_ID) ENABLE VALIDATE);
ALTER TABLE HR.EMPLOYEES ADD ( CONSTRAINT EMP_MANAGER_FK FOREIGN KEY (MANAGER_ID) REFERENCES HR.EMPLOYEES (EMPLOYEE_ID) ENABLE VALIDATE);
...
--
CREATE OR REPLACE FORCE VIEW HR.EMP_DETAILS_VIEW   SHARING=METADATA
...
--
CREATE OR REPLACE PROCEDURE HR.secure_dml sharing=metadata
IS
BEGIN
...
--
CREATE OR REPLACE TRIGGER HR.secure_employees SHARING=METADATA
